...
class DiscussionController {
    ...
    editArticle = async (req, res) => {
        ...
        await Discussion.findOneAndUpdate({_id: req.body._id}, 
            {
    ...
    deleteArticles = async (req, res) => {
        console.log("req.body", req.body);
        Discussion.findOneAndDelete({_id: req.body._id})
        .then((data) => {
            res.status(200).send(
                JSON.stringify({
                    data,
    ...
    addBigComment = async (req, res) => {
        // console.log("req.body", req.body);
        var currentArticle;
        await Discussion.findById(req.body.postID).exec()
        .then((data) => {  
            currentArticle = data;
        })
        .catch((error) => {
        ...
        // add new Discussion comment
        await Discussion.findOneAndUpdate({_id: req.body.postID}, 
            {
